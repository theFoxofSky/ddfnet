...
print(test)
test = gradcheck(ddf, (feat, channel_att, spatial_att, 3, 2, 2, 1, 'mul'), atol=1e-5, eps=1e-3)
print(test)
test = gradcheck(ddf, (feat, channel_att, spatial_att, 3, 1, 2, 1, 'add'), atol=1e-5, eps=1e-3)
print(test)
test = gradcheck(ddf, (feat, channel_att, spatial_att, 3, 2, 2, 1, 'add'), atol=1e-5, eps=1e-3)
print(test)
...
test = gradcheck(ddf, (feat, channel_att, spatial_att, 5, 1, 2, 1, 'mul'), atol=1e-5, eps=1e-3)
print(test)
test = gradcheck(ddf, (feat, channel_att, spatial_att, 5, 2, 2, 1, 'mul'), atol=1e-5, eps=1e-3)
print(test)
test = gradcheck(ddf, (feat, channel_att, spatial_att, 5, 1, 2, 1, 'add'), atol=1e-5, eps=1e-3)
print(test)
test = gradcheck(ddf, (feat, channel_att, spatial_att, 5, 2, 2, 1, 'add'), atol=1e-5, eps=1e-3)
print(test)
